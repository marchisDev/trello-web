...
/**
 * Note: Modal là một low-component mà bọn MUI sử dụng bên trong những
 * thứ như Dialog, Drawer, Menu, Popover. Ở đây dĩ nhiên chúng ta có thể
 * sử dụng Dialog cũng không thành vấn đề gì, nhưng sẽ sử dụng Modal
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid xs={12} sm={3}>
            ...
            <Stack direction='column' spacing={1}>
              ...
              {/* Neu user hien tai la owner cua card, hien thi nut Join */}
              {/* Khi click vao nut join se luon la action ADD */}
