...
function CardUserGroup({ cardMemberIds = [], onUpdateCardMembers }) {
  ...
  // Lấy thông tin board hiện tại từ Redux de lay duoc toan bo thong tin thanh vien cua board thong qua FE_allUsers
  ...
  const handleUpdateCardMembers = (user) => {
    ...
    // tao 1 bien incomingMemberInfo de gui cho BE, voi 2 thong tin chinh la userId va action
    // la xoa khoi card hoac them vao card
