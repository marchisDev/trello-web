...
function Boards() {
  ...
  useEffect(() => {
    ...
    // Moi khi url thay doi vi du nhu chung ta chuyen trang thi cai locaton.search lay tu hook
    // useLocation se thay doi va useEffect se chay lai va fetch lai API theo dung page moi vi cai location.search
    // da nam trong dependency array cua useEffect
  ...
  const afterCreateNewBoard = () => {
    // Don gian la goi lai API fetchBoardsAPI de lay lai danh sach boards sau khi tao moi board thanh cong
    fetchBoardsAPI(location.search).then(updateStateData)
  }
